# -*- coding: utf-8 -*-
"""
Created on Mon Oct 24 14:25:47 2016
...
sys.path.append("pycaffe/layers")
...
if not os.path.isfile(caffe_root + 'models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'):
    print("cannot find the caffenet model\n")
...
def caffenet_multilabel(data_layer_params, datalayer):
    ...
    # use SigmoidCrossEntropy layer to compute loss instead of SoftMaxwithLoss
...
solverprototxt = tools.CaffeSolver(trainnet_prototxt_path = osp.join(workdir, 
"trainnet.prototxt"), testnet_prototxt_path = osp.join(workdir, "valnet.prototxt"))
